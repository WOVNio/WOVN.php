<?php
  ...
  class APITest extends PHPUnit_Framework_TestCase {
    ...
    public function testTranslateWithoutMakingAPICallBySetting() {
      ...
      $html = '<html><head></head><body><h1>en</h1></body></html>';
      $expected_result = '<html><head><link rel="alternate" hreflang="en" href="http://localhost/ja/mypage.php"><script src="//j.wovn.io/1" data-wovnio="key=123456&amp;backend=true&amp;currentLang=en&amp;defaultLang=en&amp;urlPattern=query&amp;langCodeAliases=[]&amp;version=WOVN.php" async></script></head><body><h1>en</h1></body></html>';
    ...
    public function testTranslateWhenDefaultLangAndSettingIsOff() {
      ...
      $expected_url = $this->getExpectedUrl($store, $headers, $html);
      $token = $store->settings['project_token'];
      $expected_html = '<html><head><link rel="alternate" hreflang="en" href="http://localhost/mypage.php"><script src="//j.wovn.io/1" data-wovnio="key='.$token.'&amp;backend=true&amp;currentLang=ja&amp;defaultLang=en&amp;urlPattern=path&amp;langCodeAliases=[]&amp;version=WOVN.php" data-wovnio-type="fallback_snippet" async></script></head><body><h1>en</h1></body></html>';
      $response = '{"body":"<html><head><link rel=\"alternate\" hreflang=\"en\" href=\"http:\/\/localhost\/ja\/mypage.php?wovn=en\"><script src=\'\/\/j.wovn.io\/1\' data-wovnio=\'key='.$token.'\' data-wovnio-type=\'fallback_snippet\' async><\/script><\/head><body><h1>fr<\/h1><\/body><\/html>"}';
      ...
      $expected_result = '<html><head><link rel="alternate" hreflang="en" href="http://localhost/ja/mypage.php?wovn=en"><script src=\'//j.wovn.io/1\' data-wovnio=\'key='.$token.'\' data-wovnio-type=\'fallback_snippet\' async></script></head><body><h1>fr</h1></body></html>';
    ...
    public function testTranslateWithSaveMemoryBySendingWovnIgnoreContent() {
      $settings = array(
        'url_pattern_name' => 'query',
        'save_memory_by_sending_wovn_ignore_content' => true
      );
      list($store, $headers) = StoreAndHeadersFactory::fromFixture('japanese_path_request', $settings);
